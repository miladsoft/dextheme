...
// Webpack support
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
    module.exports = DEXCookie;
}

"use strict";

// Class definition
var DEXDialer = function(element, options) {
    ////////////////////////////
    // ** Private variables  ** //
    ////////////////////////////
    var the = this;
    ...
    // Constructor
    var _construct = function() {
        if ( DEXUtil.data(element).has('dialer') === true ) {
            the = DEXUtil.data(element).get('dialer');
        } else {
            _init();
        }
    }
    ...
    var _init = function() {
        ...
        // Elements
        the.element = element;
        the.incElement = the.element.querySelector('[data-dex-dialer-control="increase"]');
        the.decElement = the.element.querySelector('[data-dex-dialer-control="decrease"]');
        ...
        // Bind Instance
        DEXUtil.data(the.element).set('dialer', the);
    }

    // Handlers
    var _handlers = function() {
        DEXUtil.addEvent(the.incElement, 'click', function(e) {
            e.preventDefault();
        
            _increase();
        });

        DEXUtil.addEvent(the.decElement, 'click', function(e) {
            e.preventDefault();

            _decrease();
        });

        DEXUtil.addEvent(the.inputElement, 'input', function(e) {
            e.preventDefault();
    ...
    var _increase = function() {
        ...
        DEXEventHandler.trigger(the.element, 'kt.dialer.increase', the);

        the.inputElement.value = the.value + the.options.step;
        _setValue();

        // Trigger "before.dialer" event
        DEXEventHandler.trigger(the.element, 'kt.dialer.increased', the);
    ...
    var _decrease = function() {
        // Trigger "after.dialer" event
        DEXEventHandler.trigger(the.element, 'kt.dialer.decrease', the);
        ...
        // Trigger "before.dialer" event
        DEXEventHandler.trigger(the.element, 'kt.dialer.decreased', the);
    ...
    var _setValue = function(value) {
        // Trigger "after.dialer" event
        DEXEventHandler.trigger(the.element, 'kt.dialer.change', the);
        ...
        // Trigger "after.dialer" event
        DEXEventHandler.trigger(the.element, 'kt.dialer.changed', the);
    }
    ...
    var _getOption = function(name) {
        if ( the.element.hasAttribute('data-dex-dialer-' + name) === true ) {
            var attr = the.element.getAttribute('data-dex-dialer-' + name);
            var value = attr;            
    ...
    var _destroy = function() {
        DEXUtil.data(the.element).remove('dialer');
    }
...
// Static methods
DEXDialer.getInstance = function(element) {
    if ( element !== null && DEXUtil.data(element).has('dialer') ) {
        return DEXUtil.data(element).get('dialer');
    } else {
        return null;
    }
}
...
// Create instances
DEXDialer.createInstances = function(selector = '[data-dex-dialer="true"]') {
    // Get instances
    var elements = document.querySelectorAll(selector);

    if ( elements && elements.length > 0 ) {
        for (var i = 0, len = elements.length; i < len; i++) {
            new DEXDialer(elements[i]);
        }
    }
}

// Global initialization
DEXDialer.init = function() {
    DEXDialer.createInstances();
};


// Webpack support
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
    module.exports = DEXDialer;
}
"use strict";
...
var DEXEventHandler = function() {
    ...
    var _triggerEvent = function(element, name, target) {
        ...
        if ( DEXUtil.data(element).has(name) === true ) {
            var handlerIds = DEXUtil.data(element).get(name);
            var handlerId;
    ...
    var _addEvent = function(element, name, callback, one) {
        var handlerId = DEXUtil.getUniqueId('event');
        var handlerIds = DEXUtil.data(element).get(name);
        ...
        DEXUtil.data(element).set(name, handlerIds);
...
// Webpack support
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
    module.exports = DEXEventHandler;
}
...
// Class definition
var DEXPasswordMeter = function(element, options) {
    ////////////////////////////
    // ** Private variables  ** //
    ////////////////////////////
    var the = this;
    ...
    // Constructor
    var _construct = function() {
        if ( DEXUtil.data(element).has('password-meter') === true ) {
            the = DEXUtil.data(element).get('password-meter');
        } else {
            _init();
        }
    }
    ...
    var _init = function() {
        ...
        the.element = element;
        the.inputElement = the.element.querySelector('input[type]');
        the.visibilityElement = the.element.querySelector('[data-dex-password-meter-control="visibility"]');
        the.highlightElement = the.element.querySelector('[data-dex-password-meter-control="highlight"]'); 

        // Set initialized
        the.element.setAttribute('data-dex-password-meter', 'true');
        
        // Event Handlers
        _handlers();

        // Bind Instance
        DEXUtil.data(the.element).set('password-meter', the);
    }
    ...
    var _destroy = function() {
        DEXUtil.data(the.element).remove('password-meter');
    }
...
// Static methods
DEXPasswordMeter.getInstance = function(element) {
    if ( element !== null && DEXUtil.data(element).has('password-meter') ) {
        return DEXUtil.data(element).get('password-meter');
    } else {
        return null;
    }
}
...
// Create instances
DEXPasswordMeter.createInstances = function(selector = '[data-dex-password-meter]') {
    // Get instances
    ...
    if ( elements && elements.length > 0 ) {
        for (var i = 0, len = elements.length; i < len; i++) {
            ...
            new DEXPasswordMeter(elements[i]);
        }
    }
}

// Global initialization
DEXPasswordMeter.init = function() {
    DEXPasswordMeter.createInstances();
};


// Webpack support
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
    module.exports = DEXPasswordMeter;
}
"use strict";

// Class definition
var DEXScroll = function(element, options) {
    ////////////////////////////
    // ** Private Variables  ** //
    ////////////////////////////
    var the = this;
    ...
    var _construct = function() {
        if ( DEXUtil.data(element).has('scroll') ) {
            the = DEXUtil.data(element).get('scroll');
        } else {
            _init();
        }
    }
    ...
    var _init = function() {
        ...
        // Set initialized
        the.element.setAttribute('data-dex-scroll', 'true');

        // Update
        _update();

        // Bind Instance
        DEXUtil.data(the.element).set('scroll', the);
    }
    ...
    var _setupHeight = function() {
        ...
        if ( height !== null && height.length > 0 ) {
            DEXUtil.css(the.element, heightType, height);
        } else {
            DEXUtil.css(the.element, heightType, '');
        }
    }
    ...
    var _getStorageNamespace = function(postfix) {
        return document.body.hasAttribute("data-dex-name") ? document.body.getAttribute("data-dex-name") + "_" : "";
    }
    ...
    var _resetHeight = function() {
        DEXUtil.css(the.element, _getHeightType(), '');
    }
    ...
    var _update = function() {
        // Activate/deactivate
        if ( _getOption('activate') === true || the.element.hasAttribute('data-dex-scroll-activate') === false ) {
            _setupHeight();
            _setupStretchHeight();
            _setupScrollHandler();
            _setupState();
    ...
    var _setupStretchHeight = function() {
        ...
        if ( stretch !== null ) {
            ...
            if ( elements && elements.length == 2 ) {
                ...
                if (diff > 0) {
                    var height = parseInt(DEXUtil.css(the.element, _getHeightType())) + diff;

                    DEXUtil.css(the.element, _getHeightType(), String(height) + 'px');
                }
            }
        }
    }
    ...
    var _getAutoHeight = function() {
        var height = DEXUtil.getViewPort().height;
        ...
        if ( dependencies !== null ) {
            ...
            if ( elements && elements.length > 0 ) {
                for ( var i = 0, len = elements.length; i < len; i++ ) {
                    if ( DEXUtil.visible(elements[i]) === false ) {
                        continue;
                    }
    ...
    var _getElementHeight = function(element) {
        ...
        if (element !== null) {
            height = height + parseInt(DEXUtil.css(element, 'height'));
            height = height + parseInt(DEXUtil.css(element, 'margin-top'));
            height = height + parseInt(DEXUtil.css(element, 'margin-bottom'));

            if (DEXUtil.css(element, 'border-top')) {
                height = height + parseInt(DEXUtil.css(element, 'border-top'));
            }

            if (DEXUtil.css(element, 'border-bottom')) {
                height = height + parseInt(DEXUtil.css(element, 'border-bottom'));
            }
        } 
    ...
    var _getElementSpacing = function(element) {
        ...
        if (element !== null) {
            spacing = spacing + parseInt(DEXUtil.css(element, 'margin-top'));
            spacing = spacing + parseInt(DEXUtil.css(element, 'margin-bottom'));
            spacing = spacing + parseInt(DEXUtil.css(element, 'padding-top'));
            spacing = spacing + parseInt(DEXUtil.css(element, 'padding-bottom'));

            if (DEXUtil.css(element, 'border-top')) {
                spacing = spacing + parseInt(DEXUtil.css(element, 'border-top'));
            }

            if (DEXUtil.css(element, 'border-bottom')) {
                spacing = spacing + parseInt(DEXUtil.css(element, 'border-bottom'));
            }
        } 
    ...
    var _getOption = function(name) {
        if ( the.element.hasAttribute('data-dex-scroll-' + name) === true ) {
            var attr = the.element.getAttribute('data-dex-scroll-' + name);
    ...
    var _destroy = function() {
        DEXUtil.data(the.element).remove('scroll');
    }
...
// Static methods
DEXScroll.getInstance = function(element) {
    if ( element !== null && DEXUtil.data(element).has('scroll') ) {
        return DEXUtil.data(element).get('scroll');
    } else {
        return null;
    }
}
...
// Create instances
DEXScroll.createInstances = function(selector = '[data-dex-scroll="true"]') {
    // Initialize Menus
    var elements = document.body.querySelectorAll(selector);

    if ( elements && elements.length > 0 ) {
        for (var i = 0, len = elements.length; i < len; i++) {
            new DEXScroll(elements[i]);
        }
    }
}

// Window resize handling
DEXScroll.handleResize = function() {
    window.addEventListener('resize', function() {
        var timer;
    
        DEXUtil.throttle(timer, function() {
            // Locate and update Offcanvas instances on window resize
            var elements = document.body.querySelectorAll('[data-dex-scroll="true"]');
    
            if ( elements && elements.length > 0 ) {
                for (var i = 0, len = elements.length; i < len; i++) {
                    var scroll = DEXScroll.getInstance(elements[i]);
                    if (scroll) {
                        scroll.update();
                    }
                }
...
// Global initialization
DEXScroll.init = function() {
    DEXScroll.createInstances();
    DEXScroll.handleResize();
};


// Webpack Support
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
    module.exports = DEXScroll;
}
...
// Class definition
var DEXSearch = function(element, options) {
    ////////////////////////////
    // ** Private variables  ** //
    ////////////////////////////
    var the = this;
    ...
    // Construct
    var _construct = function() {
        if ( DEXUtil.data(element).has('search') === true ) {
            the = DEXUtil.data(element).get('search');
        } else {
            _init();
        }
    }
    ...
    var _init = function() {
        ...
        // Set initialized
        the.element.setAttribute('data-dex-search', 'true');
        ...
        // Menu
        if ( the.layout === 'menu' ) {
            the.menuObject = new DEXMenu(the.contentElement);
        } else {
            the.menuObject = null;
        }
        ...
        // Bind Instance
        DEXUtil.data(the.element).set('search', the);
    }
        ...
        if ( the.menuObject ) {
            ...
            if ( the.toggleElement ) {
                ...
                the.menuObject.on('kt.menu.dropdown.show', function(item) {
                    if (DEXUtil.visible(the.toggleElement)) {
    ...
    var _search = function() {
        if (the.processing === false) {
            ...
            the.processing = true;
            DEXEventHandler.trigger(the.element, 'kt.search.process', the);
        }
    }
    ...
    // Clear
    var _clear = function() {
        if ( DEXEventHandler.trigger(the.element, 'kt.search.clear', the) === false )  {
            return;
        }
        ...
        DEXEventHandler.trigger(the.element, 'kt.search.cleared', the);
    }
    ...
    // Get option
    var _getOption = function(name) {
        if ( the.element.hasAttribute('data-dex-search-' + name) === true ) {
            var attr = the.element.getAttribute('data-dex-search-' + name);
            var value = DEXUtil.getResponsiveValue(attr);
    ...
    var _getElement = function(name) {
        return the.element.querySelector('[data-dex-search-element="' + name + '"]');
    }

    // Check if responsive form mode is enabled
    var _getResponsiveFormMode = function() {
        var responsive = _getOption('responsive');
        var width = DEXUtil.getViewPort().width;

        if (!responsive) {
            return null;
        }

        var breakpoint = DEXUtil.getBreakpoint(responsive);
    ...
    var _destroy = function() {
        DEXUtil.data(the.element).remove('search');
    }    
...
// Static methods
DEXSearch.getInstance = function(element) {
    if ( element !== null && DEXUtil.data(element).has('search') ) {
        return DEXUtil.data(element).get('search');
    } else {
        return null;
    }
}
...
/**
 * @class DEXUtil  base utilize class that privides helper functions
 */
...
// Global variables
window.DEXUtilElementDataStore = {};
window.DEXUtilElementDataStoreID = 0;
window.DEXUtilDelegatedEventHandlers = {};

var DEXUtil = function() {
    var resizeHandlers = [];
    ...
    return {
        ...
        isDesktopDevice: function() {
            return DEXUtil.isMobileDevice() ? false : true;
        },
        ...
        getBreakpoint: function(breakpoint) {
            var value = this.getCssVariableValue('--dex-' + breakpoint);
        ...
        getHighestZindex: function(el) {
            ...
            while (el && el !== document) {
                ...
                position = DEXUtil.css(el, 'position');
                ...
                if (position === "absolute" || position === "relative" || position === "fixed") {
                    ...
                    value = parseInt(DEXUtil.css(el, 'z-index'));
            ...
            for (var i = 1; i < arguments.length; i++) {
                ...
                for (var key in obj) {
                    ...
                    if ( Object.prototype.toString.call(obj[key]) === '[object Object]' ) {
                        out[key] = DEXUtil.deepExtend(out[key], obj[key]);
                        continue;
                    }
        ...
        hasClasses: function(el, classes) {
            ...
            for (var i = 0; i < classesArr.length; i++) {
                if (DEXUtil.hasClass(el, DEXUtil.trim(classesArr[i])) == false) {
                    return false;
                }
            }
            ...
            if (el.classList) {
                for (var i = 0; i < classNames.length; i++) {
                    if (classNames[i] && classNames[i].length > 0) {
                        el.classList.add(DEXUtil.trim(classNames[i]));
                    }
                }
            } else if (!DEXUtil.hasClass(el, className)) {
                for (var x = 0; x < classNames.length; x++) {
                    el.className += ' ' + DEXUtil.trim(classNames[x]);
                }
            }
        },
        ...
        removeClass: function(el, className) {
          if (!el || typeof className === 'undefined') {
            ...
            if (el.classList) {
                for (var i = 0; i < classNames.length; i++) {
                    el.classList.remove(DEXUtil.trim(classNames[i]));
                }
            } else if (DEXUtil.hasClass(el, className)) {
                for (var x = 0; x < classNames.length; x++) {
                    el.className = el.className.replace(new RegExp('\\b' + DEXUtil.trim(classNames[x]) + '\\b', 'g'), '');
                }
            }
        },
        ...
        children: function(el, selector, log) {
            ...
            for (var i; i < l; ++i) {
                if (el.childNodes[i].nodeType == 1 && DEXUtil.matches(el.childNodes[i], selector, log)) {
        ...
        child: function(el, selector, log) {
            var children = DEXUtil.children(el, selector, log);
            ...
            return {
                set: function(name, data) {
                    ...
                    if (el.customDataTag === undefined) {
                        window.DEXUtilElementDataStoreID++;
                        el.customDataTag = window.DEXUtilElementDataStoreID;
                    }

                    if (window.DEXUtilElementDataStore[el.customDataTag] === undefined) {
                        window.DEXUtilElementDataStore[el.customDataTag] = {};
                    }

                    window.DEXUtilElementDataStore[el.customDataTag][name] = data;
                },
                ...
                get: function(name) {
                    ...
                    return this.has(name) ? window.DEXUtilElementDataStore[el.customDataTag][name] : null;
                },
                ...
                has: function(name) {
                    ...
                    return (window.DEXUtilElementDataStore[el.customDataTag] && window.DEXUtilElementDataStore[el.customDataTag][name]) ? true : false;
                },

                remove: function(name) {
                    if (el && this.has(name)) {
                        delete window.DEXUtilElementDataStore[el.customDataTag][name];
                    }
                }
            };
        },
        ...
        outerWidth: function(el, margin) {
            ...
            if (margin === true) {
                ...
                width += parseFloat(DEXUtil.css(el, 'margin-left')) + parseFloat(DEXUtil.css(el, 'margin-right'));
        ...
        actualCss: function(el, prop, cache) {
            ...
            if (!el.getAttribute('dex-hidden-' + prop) || cache === false) {
                var value;
                ...
                // store it in cache
                el.setAttribute('dex-hidden-' + prop, value);

                return parseFloat(value);
            } else {
                // store it in cache
                return parseFloat(el.getAttribute('dex-hidden-' + prop));
            }
        },

        actualHeight: function(el, cache) {
            return DEXUtil.actualCss(el, 'height', cache);
        },

        actualWidth: function(el, cache) {
            return DEXUtil.actualCss(el, 'width', cache);
        },
        ...
        slide: function(el, dir, speed, callback, recalcMaxHeight) {
            if (!el || (dir == 'up' && DEXUtil.visible(el) === false) || (dir == 'down' && DEXUtil.visible(el) === true)) {
                return;
            }

            speed = (speed ? speed : 600);
            var calcHeight = DEXUtil.actualHeight(el);
            var calcPaddingTop = false;
            var calcPaddingBottom = false;

            if (DEXUtil.css(el, 'padding-top') && DEXUtil.data(el).has('slide-padding-top') !== true) {
                DEXUtil.data(el).set('slide-padding-top', DEXUtil.css(el, 'padding-top'));
            }

            if (DEXUtil.css(el, 'padding-bottom') && DEXUtil.data(el).has('slide-padding-bottom') !== true) {
                DEXUtil.data(el).set('slide-padding-bottom', DEXUtil.css(el, 'padding-bottom'));
            }

            if (DEXUtil.data(el).has('slide-padding-top')) {
                calcPaddingTop = parseInt(DEXUtil.data(el).get('slide-padding-top'));
            }

            if (DEXUtil.data(el).has('slide-padding-bottom')) {
                calcPaddingBottom = parseInt(DEXUtil.data(el).get('slide-padding-bottom'));
            }
            ...
            if (dir == 'up') { // up
                ...
                if (calcPaddingTop) {
                    DEXUtil.animate(0, calcPaddingTop, speed, function(value) {
                        el.style.paddingTop = (calcPaddingTop - value) + 'px';
                    }, 'linear');
                }

                if (calcPaddingBottom) {
                    DEXUtil.animate(0, calcPaddingBottom, speed, function(value) {
                        el.style.paddingBottom = (calcPaddingBottom - value) + 'px';
                    }, 'linear');
                }

                DEXUtil.animate(0, calcHeight, speed, function(value) {
        ...
        slideUp: function(el, speed, callback) {
            DEXUtil.slide(el, 'up', speed, callback);
        },

        slideDown: function(el, speed, callback) {
            DEXUtil.slide(el, 'down', speed, callback);
        },
        ...
        on: function(element, selector, event, handler) {
            ...
            var eventId = DEXUtil.getUniqueId('event');

            window.DEXUtilDelegatedEventHandlers[eventId] = function(e) {
            ...
            DEXUtil.addEvent(element, event, window.DEXUtilDelegatedEventHandlers[eventId]);

            return eventId;
        },

        off: function(element, event, eventId) {
            if (!element || !window.DEXUtilDelegatedEventHandlers[eventId]) {
                return;
            }

            DEXUtil.removeEvent(element, event, window.DEXUtilDelegatedEventHandlers[eventId]);

            delete window.DEXUtilDelegatedEventHandlers[eventId];
        },
        ...
        animateClass: function(el, animationName, callback) {
            ...
            DEXUtil.addClass(el, animationName);

            DEXUtil.one(el, animation, function() {
                DEXUtil.removeClass(el, animationName);
            });

            if (callback) {
                DEXUtil.one(el, animation, callback);
            }
        },
        ...
        transitionEnd: function(el, callback) {
            ...
            DEXUtil.one(el, transition, callback);
        },
        ...
        animateDelay: function(el, value) {
            ...
            for (var i = 0; i < vendors.length; i++) {
                DEXUtil.css(el, vendors[i] + 'animation-delay', value);
            }
        },
        ...
        animateDuration: function(el, value) {
            var vendors = ['webkit-', 'moz-', 'ms-', 'o-', ''];
            for (var i = 0; i < vendors.length; i++) {
                DEXUtil.css(el, vendors[i] + 'animation-duration', value);
            }
        },

        scrollTo: function(target, offset, duration) {
            var duration = duration ? duration : 500;
            var targetPos = target ? DEXUtil.offset(target).top : 0;
            ...
            DEXUtil.animate(from, to, duration, function(value) {
        ...
        scrollTop: function(offset, duration) {
            DEXUtil.scrollTo(null, offset, duration);
        },
        ...
        getConditionalValue: function(value) {
            var value = DEXUtil.parseJson(value);
            var result = DEXUtil.getResponsiveValue(value);

            if ( result !== null && result['match'] !== undefined ) {
                result = DEXUtil.getSelectorMatchValue(result);
            }
...
var DEXApp = function () {
    ...
    var createBootstrapTooltip = function (el, options) {
        if (el.getAttribute("data-dex-initialized") === "1") {
            return;
        }
        ...
        el.setAttribute("data-dex-initialized", "1");
    ...
    var createBootstrapToasts = function () {
        ...
        var toastList = toastElList.map(function (toastEl) {
            if (toastEl.getAttribute("data-dex-initialized") === "1") {
                return;
            }

            toastEl.setAttribute("data-dex-initialized", "1");
    ...
    var createButtons = function () {
        var buttonsGroup = [].slice.call(document.querySelectorAll('[data-dex-buttons="true"]'));

        buttonsGroup.map(function (group) {
            if (group.getAttribute("data-dex-initialized") === "1") {
                return;
            }

            var selector = group.hasAttribute('data-dex-buttons-target') ? group.getAttribute('data-dex-buttons-target') : '.btn';
            var activeButtons = [].slice.call(group.querySelectorAll(selector));

            // Toggle Handler
            DEXUtil.on(group, selector, 'click', function (e) {
            ...
            group.setAttribute("data-dex-initialized", "1");
        });
    }
    ...
    var createDateRangePickers = function() {
        ...
        var elements = [].slice.call(document.querySelectorAll('[data-dex-daterangepicker="true"]'));
        var start = moment().subtract(29, 'days');
        var end = moment();
        
        elements.map(function (element) {
            if (element.getAttribute("data-dex-initialized") === "1") {
                return;
            }

            var display = element.querySelector('div');
            var attrOpens  = element.hasAttribute('data-dex-daterangepicker-opens') ? element.getAttribute('data-dex-daterangepicker-opens') : 'left';
            var range = element.getAttribute('data-dex-daterangepicker-range');
            ...
            element.setAttribute("data-dex-initialized", "1");
        });
    }
    ...
    var createSelect2 = function () {
        ...
        var elements = [].slice.call(document.querySelectorAll('[data-control="select2"], [data-dex-select2="true"]'));
    ...
    var createAutosize = function () {
        var inputs = [].slice.call(document.querySelectorAll('[data-dex-autosize="true"]'));

        inputs.map(function (input) {
            if (input.getAttribute("data-dex-initialized") === "1") {
                return;
            }

            autosize(input);

            input.setAttribute("data-dex-initialized", "1");
        });
    }

    var createCountUp = function () {
        var elements = [].slice.call(document.querySelectorAll('[data-dex-countup="true"]:not(.counted)'));

        elements.map(function (element) {
            if (DEXUtil.isInViewport(element) && DEXUtil.visible(element)) {
                if (element.getAttribute("data-dex-initialized") === "1") {
                    return;
                }
                ...
                var value = element.getAttribute('data-dex-countup-value');
                value = parseFloat(value.replace(/,/g, ""));

                if (element.hasAttribute('data-dex-countup-start-val')) {
                    options.startVal = parseFloat(element.getAttribute('data-dex-countup-start-val'));
                }

                if (element.hasAttribute('data-dex-countup-duration')) {
                    options.duration = parseInt(element.getAttribute('data-dex-countup-duration'));
                }

                if (element.hasAttribute('data-dex-countup-decimal-places')) {
                    options.decimalPlaces = parseInt(element.getAttribute('data-dex-countup-decimal-places'));
                }

                if (element.hasAttribute('data-dex-countup-prefix')) {
                    options.prefix = element.getAttribute('data-dex-countup-prefix');
                }

                if (element.hasAttribute('data-dex-countup-separator')) {
                    options.separator = element.getAttribute('data-dex-countup-separator');
                }

                if (element.hasAttribute('data-dex-countup-suffix')) {
                    options.suffix = element.getAttribute('data-dex-countup-suffix');
                }
    ...
    var createCountUpTabs = function () {
        ...
        var tabs = [].slice.call(document.querySelectorAll('[data-dex-countup-tabs="true"][data-bs-toggle="tab"]'));
        tabs.map(function (tab) {
            if (tab.getAttribute("data-dex-initialized") === "1") {
                return;
            }

            tab.addEventListener('shown.bs.tab', createCountUp);

            tab.setAttribute("data-dex-initialized", "1");
        });
    ...
    var createTinySliders = function () {
        ...
        var initSlider = function (el) {
            ...
            if (el.closest('.tns')) {
                DEXUtil.addClass(el.closest('.tns'), 'tns-initiazlied');
            }
    ...
    var initSmoothScroll = function () {
        if (SmoothScroll) {
            new SmoothScroll('a[data-dex-scroll-toggle][href*="#"]', {
                speed: 1000,
                ...
                offset: function (anchor, toggle) {
                    ...
                    if (anchor.hasAttribute('data-dex-scroll-offset')) {
                        var val = DEXUtil.getResponsiveValue(anchor.getAttribute('data-dex-scroll-offset'));
    ...
    var initCheck = function () {
        // Toggle Handler
        DEXUtil.on(document.body, '[data-dex-check="true"]', 'change', function (e) {
            var check = this;
            var targets = document.querySelectorAll(check.getAttribute('data-dex-check-target'));

            DEXUtil.each(targets, function (target) {
    ...
    var initBootstrapCollapse = function() {
        DEXUtil.on(document.body,  '.collapsible[data-bs-toggle="collapse"]', 'click', function(e) {
            ...
            if (this.hasAttribute('data-dex-toggle-text')) {
                var text = this.getAttribute('data-dex-toggle-text');
                var target = this.querySelector('[data-dex-toggle-text-target="true"]');
                var target = target ? target : this;

                this.setAttribute('data-dex-toggle-text', target.innerText);
    ...
    var initBootstrapRotate = function() {
        DEXUtil.on(document.body,  '[data-dex-rotate="true"]', 'click', function(e) {
    ...
    var initPageLoader = function () {
        ...
        DEXUtil.removeClass(document.body, 'page-loading');
        document.body.removeAttribute('data-dex-app-page-loading');
    }
...
// Declare DEXApp for Webpack support
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
    module.exports = DEXApp;
}
"use strict";

// Class definition
var DEXAppLayoutBuilder = function() {
	var form;
	var actionInput;
	var url;
	var previewButton;
	...
	var handlePreview = function() {
		previewButton.addEventListener("click", function(e) {
			...
			// Show progress
			previewButton.setAttribute("data-dex-indicator", "on");
			...
			$.ajax({
				...
				complete: function() {
					previewButton.removeAttribute("data-dex-indicator");
				}
			});
		});
	};
	...
	var handleExport = function() {
		exportButton.addEventListener("click", function(e) {
			...
			// Show progress
			exportButton.setAttribute("data-dex-indicator", "on");
				...
				success: function(response, status, xhr) {
					var timer = setInterval(function() {
						$("<iframe/>").attr({
							...
							exportButton.removeAttribute("data-dex-indicator");
						}).appendTo("body");
					}, 3000);
				},
				error: function(response) {
	...
	var handleReset = function() {
		resetButton.addEventListener("click", function(e) {
			...
			// Show progress
			resetButton.setAttribute("data-dex-indicator", "on");
			...
			$.ajax({
				...
				complete: function() {
					resetButton.removeAttribute("data-dex-indicator");
				},
			});
		});
	};
	...
	return {
		// Public functions
		init: function() {
            form = document.querySelector("#dex_app_layout_builder_form");
            ...
            actionInput = document.querySelector("#dex_app_layout_builder_action");            
            previewButton = document.querySelector("#dex_app_layout_builder_preview");
            exportButton = document.querySelector("#dex_app_layout_builder_export");
            resetButton = document.querySelector("#dex_app_layout_builder_reset");
...
// Class definition
var DEXLayoutToolbar = function () {
    // Private variables
    var toolbar;

    // Private functions
    var initForm = function () {
        var rangeSlider = document.querySelector("#dex_app_toolbar_slider");
        var rangeSliderValueElement = document.querySelector("#dex_app_toolbar_slider_value");
    ...
    return {
        init: function () {
            // Elements
            toolbar = document.querySelector('#dex_app_toolbar');
