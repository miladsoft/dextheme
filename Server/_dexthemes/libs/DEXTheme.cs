...
// Core theme class
public class DEXTheme: IDEXTheme
{
    // Theme variables
    ...
    {
        return $"/{DEXThemeSettings.config.AssetsDir}{path}";
    }
    ...
    {
        return getAssetsFullPath(DEXThemeSettings.config.Assets.Favicon);
    }

    // Include the fonts from settings
    public string[] getFonts()
    {
        return DEXThemeSettings.config.Assets.Fonts.ToArray();
    }
    ...
    {
        List<string> files =
            type == "Css" ? DEXThemeSettings.config.Assets.Css : DEXThemeSettings.config.Assets.Js;
